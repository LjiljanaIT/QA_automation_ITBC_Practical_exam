...
public class Summer_DressesTest {
	...
	@Test
	public void test07_register() throws IOException {
		...
		// test.test01_register();

	}

	@Test // Registration of one user, who already added to basket
	public void test08_register() throws IOException {
	...
	@Test //Register back one user, is item still in the basket?
	public void test09_registerBack() throws IOException {
		...
		String actual = driver.findElement(By.xpath("//div[@class='shopping_cart']//span[@class='ajax_cart_no_product']")).getText();
		sa.assertEquals(actual, "2");
		sa.assertAll();
